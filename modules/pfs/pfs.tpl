      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="btn-group">
                <a href="{PFF_ROW_EDIT_URL}" class="btn btn-sm btn-default"><i class="fa fa-pencil-square-o"></i> {PHP.L.Edit}</a>
                <a href="{PFF_ROW_DELETE_URL}" class="btn btn-sm btn-danger"><i class="fa fa-times-circle-o"></i></a>
              </div>
            </td>
          </tr>
          <!-- END: PFF_ROW -->
